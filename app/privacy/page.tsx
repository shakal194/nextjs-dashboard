...
export default function Page() {
  return (
    <>
      <Header />
      <section className="privacy py-[72px] lg:py-[150px]">
              ...
              <ul className="list-inside list-none">
                <li className="mt-8">
                  ...
                  <p className="mt-4">
                    ...
                    you provide us during the usage of{' '}
                    <Link
                    ...
                    website &#40;hereinafter - the &quot;Website&quot;&#41; or
                    our products. It governs the rules of personal data
                    processing of our clients, their partners representatives
                    and all other Website visitors
                  </p>
                  <p className="mt-4">
                    Company commits to protect your privacy. We have implemented
                    all necessary legal, technical and organisational measures
                    to ensure confidentiality, integrity and availability of
                    your Personal Information.
                  </p>
                  <p className="mt-4">
                    Under &quot;Personal Information&quot; or &quot;Personal
                    Data&quot; we mean any data you can be identified with or
                    which may help to identify you.
                  </p>
                  <p className="mt-4">
                    Personal Information Protection and Electronic Documents Act
                    &#40;further, the &quot;PIPEDA&quot;&#41; applies to
                    processing of Personal Information by Company.Personal
                    Information Protection and Electronic Documents Act
                    &#40;further, the &quot;PIPEDA&quot;&#41; applies to
                    processing of Personal Information by Company.
                  </p>
                </li>
                <li className="mt-8">
                  <p className="font-bold">
                  ...
                  <ul className="ml-6 list-inside list-disc">
                    ...
                    <li className="mt-4">
                      other information required in accordance with the AML
                      policy and/or Terms of Use
                    </li>
                  </ul>
                  <p className="mt-4">
                    ...
                    vendors, ID verification, anti-fraud and transaction
                    monitoring services.
                  </p>
                  <p className="mt-4">
                    Please note that we will not be able to provide our services
                    to you if you refuse to provide us information according to
                    our KYC/AML requirements communicated to you once you decide
                    to apply for any of our services that require verification
                    of identity and ongoing monitoring of activity. Please keep
                    in mind that in some cases we may require additional details
                    and documents for KYC and AML/CTF purposes.
                  </p>
                  <p className="mt-4">
                    Please note that processing of your Personal Data may
                    include automated decision-making including profiling. We
                    may apply automated decision-making including profiling for
                    onboarding, maintaining the account with us and fraud
                    prevention purposes.
                  </p>
                </li>
                <li className="mt-8">
                  ...
                  <ul className="ml-6 list-inside list-disc">
                    <li className="mt-4">
                      to provide our services to you, as individual, or a
                      corporate client you represent;
                    </li>
                    <li className="mt-4">
                    ...
                    <li className="mt-4">
                      to provide assistance in case of criminal investigation
                    ...
                    <li className="mt-4">
                      to provide you information on our products, news and
                      updates;
                    </li>
                    <li className="mt-4">
                      to resolve disputes and protect your interests or
                  ...
                  <ul className="ml-6 list-inside list-disc">
                    ...
                    <li className="mt-4">
                      We have a legal obligation to comply with AML/CTF
                ...
                <li className="mt-8">
                  ...
                  <ul className="ml-6 list-inside list-disc">
                    ...
                    <li className="mt-4">
                      ...
                      beacon&#41; is a piece of code embedded in our Services
                      that collects information about engagement on our
                      Services.
                    </li>
                  </ul>
                </li>
                <li className="mt-8">
                  ...
                  <ul className="ml-6 list-inside list-disc">
                    ...
                    <li className="mt-4">
                      our contractors providing software for identity
                    ...
                    <li className="mt-4">
                      our financial service providers through which we
                      facilitate fiat currency transactions to/from our
                      services;
                    </li>
                    <li className="mt-4">
                ...
                <li className="mt-8">
                  ...
                  <p className="mt-4">
                    ...
                    your personal data just to comply with our legal
                    obligations, resolve disputes, and protect your and our
                    legitimate interests.
                  </p>
                  <p className="mt-4">
                    We will keep your Personal Information for a maximum period
                    of five &#40;5&#41; years upon termination of legal
                    relationships with us.
                  </p>
                  <p className="mt-4">
                    You can always request to remove the personal data. But keep
                    in mind that in certain cases we are obliged to store your
                ...
                <li className="mt-8">
                  ...
                  <ul className="ml-6 list-inside list-disc">
                    ...
                    <li className="mt-4">
                      ...
                      to rectify information you think is inaccurate. You also
                      have the right to ask us to complete information you think
                      is incomplete.
                    </li>
                    <li className="mt-4">
                    ...
                    <li className="mt-4">
                      Your right to restriction of processing - You have the
                      right to ask us to restrict the processing of your
                      information.
                    </li>
                    <li className="mt-4">
                  ...
                  <p className="mt-4">
                    Please note that in some cases we will not be able to
                    fulfill your request due to our legal obligations or
                    overriding legitimate interest. In such cases we will
                    explain you the reasons why your request cannot be fulfilled
                    and how you can complain.
                  </p>
                </li>
                <li className="mt-8">
                  <p className="font-bold">
                  ...
                  <p className="mt-4">
                    ...
                    acknowledged international security standards. Our platform
                    also uses SSL or TLS encryption for security reasons and for
                    the protection of confidential content transmission when you
                    send us requests.
                  </p>
                </li>
                <li className="mt-8">
                  ...
                  <p className="mt-4">
                    Company may introduce amendments to the current Policy at
                    any time. We may notify you on our Website or via E-mail.
                  </p>
                </li>
              </ul>
            </div>

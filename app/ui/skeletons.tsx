...
export function TableRowSkeleton() {
  return (
    <tr className="w-full border-b border-gray-100 last-of-type:border-none dark:text-gray-50 [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-100 p-2 dark:bg-gray-800 md:pt-0">
          ...
          <table className="hidden min-w-full text-gray-900 md:table">
            <thead className="rounded-lg text-left text-sm font-normal dark:text-gray-300">
              <tr>
...
/*export function WalletSkeleton() {
  return (
    <div className="mt-6 flex gap-4">
      <div
        className={`${shimmer} relative flex items-center overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800 p-2 shadow-sm`}
      >
        <div className="mr-2 h-10 w-20 rounded-md bg-gray-200 dark:bg-gray-400" />
        <div className="h-10 w-40 rounded-md bg-gray-200 dark:bg-gray-400" />
      </div>
    </div>
  );
}*/
    ...
    <div className="mt-6 flex flex-col">
      ...
      <div className="mt-6 flex gap-4">
        <div
          className={`${shimmer} relative flex items-center overflow-hidden rounded-lg bg-gray-100 p-2 shadow-sm dark:bg-gray-800`}
        >
          <div className="mr-2 h-10 w-24 rounded-lg bg-gray-200 px-4 dark:bg-gray-400"></div>
          <div className="h-10 w-32 rounded-lg bg-gray-200 px-4 dark:bg-gray-400"></div>
        </div>
      </div>
    </div>
  );

...
const AboutUs = () => {
  return (
    <main className="flex min-h-screen flex-col p-6">
      <Header />
      <section className="title-descr white_section py-40">
        <div className="container mx-auto px-4">
          <div className="title-descr__inner mx-auto max-w-2xl text-left">
            <h1 className="title-descr__title text-3xl font-semibold md:text-4xl">
              <span className="text-blue-600">Coinsfish</span> is a crypto
              processing solution that enables you to Accept, Store, Receive,
              Send and Exchange crypto payments.
            </h1>
          </div>
        </div>
      </section>
      ...
      <section className="new-standard white_section py-40">
        <div className="container mx-auto px-4">
          <div className="new-standard__inner flex max-w-7xl justify-between">
            <div className="new-standard__box mb-8">
              <span className="new-standard__subtitle text-base font-medium text-blue-600">
                Our main goal
              </span>
            ...
            <div className="new-standard__box w-1/2">
